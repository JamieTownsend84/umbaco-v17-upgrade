...
We had lots of instances of advanced labels, so I've also included a SQL Script you can run on your database to aid you in finding them all.

You can find a full example of updating a block element label [here](../Deprecated%20Property%20Editors/MigrationExample/UpdateBlockElementTitleMigration.cs)
